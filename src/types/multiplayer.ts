// ===================================================================
// MULTIPLAYER TYPES - Complete Fixed Version
...
// Room/Session Interfaces (GameRoom ist das Haupt-Interface)
export interface GameRoom {
  ...
  players: Player[];
  host: GameUser;          // ✅ Verwendet 'host' statt 'hostUser'
...
// Legacy Compatibility - GameSession ist ALIAS für GameRoom
...
// Message Interfaces - FIXED VERSION
export interface ChatMessage {
  ...
  message: string;
  timestamp: Date;
  type: 'text' | 'system' | 'emoji';  // ✅ Entfernt 'user', hinzugefügt 'text'
}
...
// Helper Functions für ChatMessage Creation
export const createSystemMessage = (message: string, data?: any): ChatMessage => ({
...
export const createTextMessage = (senderId: string, senderName: string, message: string): ChatMessage => ({
  id: Date.now().toString(),
  senderId,
  senderName,
  message,
