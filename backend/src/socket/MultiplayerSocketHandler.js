        ...
        this.io.on('connection', (socket) => {
            ...
            socket.on('create_session', async (data) => {
                try {
                    ...
                    console.log(`🎮 Session created: ${session.id} by ${user.username}`);
            ...
            socket.on('join_session', async (data) => {
                try {
                    ...
                    console.log(`👤 ${user.username} joined session ${sessionId} (${asSpectator ? 'spectator' : 'player'})`);
            ...
            socket.on('chat_message', async (data) => {
                try {
                    ...
                    console.log(`💬 Chat in ${sessionId}: ${user.username}: ${message}`);
    ...
    async handlePlayerLeave(socket) {
        try {
            ...
            if (realtimeSession.sockets.size === 0) {
                ...
                console.log(`🗑️ Real-time session ${sessionId} cleaned up`);
            }
...
// ========================================
// 2. INTEGRATION WITH EXISTING SERVER - backend/server.js
// ========================================

/* ADD TO YOUR EXISTING server.js:

const MultiplayerSocketHandler = require('./src/socket/MultiplayerSocketHandler');
...
// ========================================
// 3. FRONTEND HOOK - frontend/src/hooks/useMultiplayerSocket.js
// ========================================
...
module.exports = MultiplayerSocketHandler;